    ...
    <div class="rn-authore-profile-area">
        <div class="container">
            ...
            <div class="tab-content rn-bid-content" id="nav-tabContent">
                ...
                <div class="tab-pane row g-5 d-flex fade" id="nav-created" role="tabpanel" aria-labelledby="nav-created-tab">
                                    ...
                                    <div class="card-thumbnail">
                                        <a href="#">
                                            @if ($product->getFirstMedia())
                                                <img src="{{ $product->getFirstMediaUrl() }}" alt="Product Image">
                                            @else
                                                <!-- Provide a placeholder image or default image -->
                                                <img src="{{ asset('assets/images/portfolio/portfolio-09.jpg') }}" alt="Placeholder Image">
                                            @endif
                                        </a>
                                        <a href="#" class="btn btn-primary">Place Bid</a>
                                    </div>
                                    <div class="product-share-wrapper">
                                        <!-- Profile share and share button HTML -->
                                    </div>
