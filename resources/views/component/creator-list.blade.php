...
@foreach($creators as $creator)
    <div class="creator-single col-lg-3 col-md-4 col-sm-6" data-sal="slide-up" data-sal-delay="150" data-sal-duration="800" style="opacity: unset">
        <a href="{{ route('user.profile', ['id' => $creator->id]) }}">

            <div class="top-seller-inner-one explore">
                <div class="top-seller-wrapper">
                    <div class="thumbnail verified">
                        <a href="{{ route('user.profile', ['id' => $creator->id]) }}"><img src="{{ $creator->avatar ?? 'assets/images/default-avatar.png' }}" alt="Nft_Profile"></a>
                    </div>
                ...
                <a class="over-link" href="{{ route('user.profile', ['id' => $creator->id]) }}"></a>
            </div>
