        ...
        <li class="comment parent" data-comment-id="{{ $comment->id }}">
            <div class="single-comment">
                <div class="comment-author comment-img">
                    ...
                    <div class="m-b-20">
                        <div class="commenter">{{ $comment->user->name }}</div>
                ...
                <ul class="children">
                    @foreach($comment->children as $child)
                        <li class="comment byuser">
                            <div class="single-comment">
                                <div class="comment-author comment-img">
                                    <img class="comment-avatar" src="{{ $child->user->profile_image_url }}" alt="Comment Image">
                                    <div class="m-b-20">
                                        <div class="commenter">{{ $child->user->name }}</div>
